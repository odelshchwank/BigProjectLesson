...
const docTemplate = `{
        ...
        "/tasks/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID удаляемой задач",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "github_com_odelshchwank_BigProjectLesson_internal_core_transport_http_types.Nullable-string": {
            "type": "object",
            "properties": {
                "set": {
                    "type": "boolean"
        ...
        "internal_features_tasks_transport_http.CreateTaskResponse": {
            ...
            "properties": {
                ...
                "created_at": {
                    "type": "string",
                    "example": "2026-05-28T11:21:35.490823Z"
                },
                "description": {
                    "type": "string",
                    "example": "Long description"
        ...
        "internal_features_users_transport_http.PatchUserRequest": {
            ...
            "properties": {
                "full_name": {
                    "$ref": "#/definitions/github_com_odelshchwank_BigProjectLesson_internal_core_transport_http_types.Nullable-string"
                },
                "phone_number": {
                    "$ref": "#/definitions/github_com_odelshchwank_BigProjectLesson_internal_core_transport_http_types.Nullable-string"
                }
