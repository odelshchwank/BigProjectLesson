...
import (
	...
	statistics_postgres_repository "github.com/odelshchwank/BigProjectLesson/internal/features/statistics/repository/postgres"
	statistics_service "github.com/odelshchwank/BigProjectLesson/internal/features/statistics/service"
	statistics_transport_http "github.com/odelshchwank/BigProjectLesson/internal/features/statistics/transport/http"
	...
	web_fs_repository "github.com/odelshchwank/BigProjectLesson/internal/features/web/repository/file_system"
	web_service "github.com/odelshchwank/BigProjectLesson/internal/features/web/service"
	web_transport_http "github.com/odelshchwank/BigProjectLesson/internal/features/web/transport/http"
	"go.uber.org/zap"
...
func main() {
	...
	// Инициализируем все наши слои (бд, сервис и транспорт) фичи web
	...
	// Закончили инициализацию слоёв фичи web
	...
	httpServer := core_http_server.NewHTTPServer(
		httpConfig,
		logger,
		core_http_middleware.CORS(httpConfig.AllowedOrigin),
